...
from benchmark.config import BlsKey,EdKey, LocalCommittee, NodeParameters, BenchParameters, ConfigError
...
class LocalBench:
    ...
    def run(self, debug=False, consensus_only=False):
        ...
        try:
            ...
            cmd = CommandMaker.generate_bls_keys(nodes, self.bench_parameters.bls_threshold, PathMaker.bls_file_default_path()).split()
            ...
            return LogParser.process(PathMaker.logs_path(), consensus_only=consensus_only, debug=debug)
