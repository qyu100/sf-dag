...
class LogParser:
    def __init__(self, clients, primaries, burst, faults=0, consensus_only=True):
        inputs = [primaries]
        ...
        self.collocate = set(primary_ips) == True
    ...
    @classmethod
    def process(cls, directory, burst, faults=0, consensus_only=True):
